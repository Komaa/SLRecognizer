...
The skeleton for this project has been forked from https://github.com/udacity/AIND-Recognizer
...
In a terminal or command window, navigate to the top-level project directory `SLrecognizer/` (that contains this README) and run one of the following command:
